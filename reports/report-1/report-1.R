...
# ---- declare-globals ------------------------------------------------------
path_model_result <- "./data-unshared/derived/model_result.rds"
path_ds_catalog <-  "./data-public/derived/ds_catalog.rds"
path_ls_catalog <-   "./data-public/derived/ls_catalog.rds"

# ---- load-data -------------------------------------------------------------
model_result <- readRDS(path_model_result)
ds_catalog  <- readRDS(path_ds_catalog)
ls_catalog  <- readRDS(path_ls_catalog)

# ---- inspect-data -------------------------------------------------------------
ds <- model_result$savedata
dd <- model_result$savedata_info
res <- model_result

model_result$summaries  
model_result$parameters$unstandardized
model_result$

mt <- model_result$parameters$unstandardized
# ---- tweak-data --------------------------------------------------------------
# See Mplus annotations:
# https://stats.idre.ucla.edu/mplus/output/lgcm_mlm/mlmtwolevel2/
